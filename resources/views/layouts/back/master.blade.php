...
<head>
    ...
    <link href="{{asset('back/vendor/vector-map/jqvmap.min.css')}}" rel="stylesheet" media="all">
...
<div class="page-wrapper">
    ...
    <aside class="menu-sidebar2">
        <div class="logo">
            <a href="#">
                <img src="{{asset('back/images/icon/logo-white.png')}}" alt="Cool Admin" />
            </a>
        </div>
        <div class="menu-sidebar2__content js-scrollbar1">
            <div class="account2">
                <div class="image img-cir img-120">
                    <img src="{{asset('back/images/icon/avatar-big-01.jpg')}}" alt="John Doe" />
                </div>
                ...
                <div class="container-fluid">
                    <div class="header-wrap2">
                        <div class="logo d-block d-lg-none">
                            <a href="#">
                                <img src="{{asset('back/images/icon/logo-white.png')}}" alt="CoolAdmin" />
                            </a>
                        </div>
...
<script src="{{asset('back/vendor/vector-map/jquery.vmap.js')}}"></script>
<script src="{{asset('back/vendor/vector-map/jquery.vmap.min.js')}}"></script>
<script src="{{asset('back/vendor/vector-map/jquery.vmap.sampledata.js')}}"></script>
<script src="{{asset('back/vendor/vector-map/jquery.vmap.world.js')}}"></script>
